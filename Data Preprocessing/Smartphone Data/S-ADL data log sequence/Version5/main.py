...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        for req in reqs[2:]:
            ...
            if find:
                info = dict()
                for target in ['packageName', 'type', 'isPosted', 'messageBox']:
    ...
    find_rows = find_rows[['offsetTimestamp', 'timestamp', 'value', 'datumType']]
    find_rows.to_excel('result.xlsx', encoding='utf-8', float_format='str')
